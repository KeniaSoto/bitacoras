...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="t_nuevo.js"></script>
                ...
                <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="formCampos">
                                <div id="camposO" class="">
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-6" align="center">
                                            <div class="form-group">
                                                <label class="control-label" >Fecha</label>
                                                <input type="date" name="date0" id="date0" class="form-control input-group-lg" placeholder="Fecha" required>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 col-md-6" align="center">
                                            <div class="form-group">
                                                <label class="control-label">Pago por la gasolina</label>
                                                <input type="text" name="pago0" id="pago0" class="form-control input-group-lg" placeholder="$" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-6" >
                                            <div class="form-group" align="center">
                                                ...
                                                <input type="text" name="km0" id="km0" class="form-control input-group-lg" placeholder="Km" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                       <!-- <input type="hidden" name="funcion" value="agregarBitacora"> -->
                                        <input type="button" id="add" value="Aceptar" class="btn btn-info btn-block">
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                        <input type="button" value="Cancelar" class="btn btn-danger btn-block" id="cancelar">
                                    </div>
                                </div>
                        </div>
                    </div>
